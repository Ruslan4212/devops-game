...
const HAIR_PATHS: Record<string, string> = {
  короткие: `M78 ${HEAD_CY - 3}c0-17 9-28 22-28s22 11 22 28c0-6-2-11-4-14-6 5-14 7-22 7s-14-2-18-6c0 5 0 10 0 13z`,
  ёжик: `M79 ${HEAD_CY - 6}c1-15 10-25 21-25s20 10 21 25c-4-8-11-12-21-12s-17 4-21 12z`,
  "с пробором": `M78 ${HEAD_CY - 3}c0-17 9-28 22-28 5 0 9 1 12 3-6 2-10 6-12 11-4-6-11-8-18-6-3 4-4 12-4 20z M104 ${HEAD_CY - 17}c7-4 16-1 18 8 1 3 2 7 2 11 0-8-1-15-5-18-4-3-10-4-15-1z`,
  кудри: `M77 ${HEAD_CY - 4}a8 8 0 0 1 4-11 9 9 0 0 1 8-9 9 9 0 0 1 11-4 9 9 0 0 1 11 4 9 9 0 0 1 8 9 8 8 0 0 1 4 11 7 7 0 0 1-3 5c1-8-2-13-6-15-4 4-10 6-14 6s-10-2-14-6c-4 2-7 7-6 15a7 7 0 0 1-3-5z`,
  длинные: `M78 ${HEAD_CY - 3}c0-17 9-28 22-28s22 11 22 28c0 14-1 26-3 36l-7-2c2-11 2-22-1-30-5 5-12 7-19 7s-13-2-17-6c-2 8-2 18 0 29l-7 2c-2-10-3-22-3-36z`,
  лысина: `M80 ${HEAD_CY - 2}c1-8 4-14 9-18-6 6-8 12-9 18z M111 ${HEAD_CY - 20}c5 4 8 10 9 18-1-6-3-12-9-18z`,
  афро: `M72 ${HEAD_CY - 4}a16 16 0 0 1 8-19 15 15 0 0 1 20-6 15 15 0 0 1 20 6 16 16 0 0 1 8 19 14 14 0 0 1-4 9c2-12-2-19-8-22-5 5-10 7-16 7s-11-2-16-7c-6 3-10 10-8 22a14 14 0 0 1-4-9z`,
  "гладко назад": `M78 ${HEAD_CY - 2}c0-17 9-28 22-28s22 11 22 28c0-3-1-5-2-7-5-8-12-11-20-11s-15 3-20 11c-1 2-2 4-2 7z`,
  каре: `M77 ${HEAD_CY - 2}c0-18 10-29 23-29s23 11 23 29c0 12-1 21-2 28l-8-1c2-9 2-19-1-26-5 5-12 7-19 7s-13-2-17-6c-2 7-2 17 0 25l-8 1c-1-7-2-16-2-28z`,
  хвост: `M78 ${HEAD_CY - 3}c0-17 9-28 22-28s22 11 22 28c0-6-2-11-4-14-6 5-14 7-22 7s-14-2-18-6c0 5 0 10 0 13z M120 ${HEAD_CY - 4}c8 2 13 9 13 19 0 8-2 15-5 20l-6-4c3-5 4-11 4-17 0-8-3-14-8-16z`,
  пучок: `M78 ${HEAD_CY - 2}c0-17 9-28 22-28s22 11 22 28c0-6-2-11-4-14-6 5-14 7-22 7s-14-2-18-6c0 5 0 10 0 13z M100 ${TOP - 4}a9 9 0 1 1 0 18 9 9 0 0 1 0-18z`,
  чёлка: `M77 ${HEAD_CY - 1}c0-18 10-29 23-29s23 11 23 29c0 6-1 11-2 15l-6-1c1-6 1-13-1-18-5 5-12 8-20 8s-14-2-18-7c-2 5-2 12-1 18l-6 1c-1-4-2-9-2-16z`,
  локоны: `M76 ${HEAD_CY - 3}a9 9 0 0 1 5-12 10 10 0 0 1 9-9 10 10 0 0 1 10-4 10 10 0 0 1 10 4 10 10 0 0 1 9 9 9 9 0 0 1 5 12c0 12-2 22-4 30l-7-2c2-9 2-18 0-25-5 5-11 7-17 7s-12-2-17-7c-2 7-2 16 0 25l-7 2c-2-8-4-18-4-30z`,
};

export function hairPath(sex: Sex, style: number): string {
  const list = hairStyles(sex);
  const name = list[style] ?? list[0];
  return `<path d="${HAIR_PATHS[name] || HAIR_PATHS["короткие"]}"/>`;
}
...
export function avatarSVG(a: Appearance, o: AvatarOptions = {}): string {
  ...
  const hair =
    `<g fill="url(#hair${id})">${hairPath(a.sex, a.hair)}</g>` +
